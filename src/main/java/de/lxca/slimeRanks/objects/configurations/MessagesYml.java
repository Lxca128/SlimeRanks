...
public class MessagesYml extends Yml {
    ...
    protected void setDefaultYmlKeys() {
        ...
        createConfigKey("Gui.Edit.ItemLore.PermissionStatus", List.of("", "<color:#39ff14>Click</color> <gray>to set the permission</gray><dark_gray>.</dark_gray>", "<color:#39ff14>Shift-Click</color> <gray>to remove the permission</gray><dark_gray>.</dark_gray>"));
