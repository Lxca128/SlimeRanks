...
public class MessagesYml extends Yml {
    ...
    protected void setDefaultYmlKeys() {
        ...
        createConfigKey("Chat.Input.Chat.Input.RankPriority", "<gray>Please enter the desired <color:#39ff14>rank priority</color> as a <color:#39ff14>number</color><dark_gray>.</dark_gray></gray><newline><gray>If a player has multiple ranks<dark_gray>,</dark_gray> they will use the rank with the highest priority<dark_gray>.</dark_gray>");
